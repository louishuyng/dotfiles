...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'lspsaga.nvim', 'nvim-colorizer.lua', 'lspkind-nvim', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
