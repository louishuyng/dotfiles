...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-lspconfig', 'indent-blankline.nvim', 'lspkind-nvim', 'nvim-treesitter', 'lspsaga.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
