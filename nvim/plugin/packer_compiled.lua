...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'nvim-colorizer.lua', 'nvim-lspconfig', 'indent-blankline.nvim', 'lspkind-nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
