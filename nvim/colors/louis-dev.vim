...
let g:colors_name = 'louis-dev'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'monokai-pro_palette', 'soft')
let s:configuration.transparent_background = get(g:, 'monokai-pro_transparent_background', 1)
let s:configuration.disable_italic_comment = get(g:, 'monokai-pro_disable_italic_comment', 1)
let s:configuration.enable_italic = get(g:, 'monokai-pro_enable_italic', 0)
let s:configuration.cursor = get(g:, 'monokai-pro_cursor', 'auto')
let s:configuration.current_word = get(g:, 'monokai-pro_current_word', get(g:, 'monokai-pro_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
