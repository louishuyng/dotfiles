        ...
        hook = function(keybinds)
          ...
          keybinds.map_event_to_mode("norg", {
            n = { -- Bind keys in normal mode
              {"<leader>fl", "core.integrations.telescope.find_linkable"}, -- Keys for managing GTD
              {"<leader>tc", "core.gtd.base.capture"},
              {"<leader>tv", "core.gtd.base.views"},
              {"<leader>te", "core.gtd.base.edit"}, -- Keys for managing notes
              {"<leader>nn", "core.norg.dirman.new.note"}, -- mnemonic: markup toggle
