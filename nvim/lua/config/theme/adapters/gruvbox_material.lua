...
function M.setup()
  ...
  -- Leave better_performance off: it defers plugin highlights into
  -- after/syntax/<ft>/, which run *after* our ColorScheme hook and stomp
  -- ui/tree.lua's NvimTreeNormal back to bg_dim.
