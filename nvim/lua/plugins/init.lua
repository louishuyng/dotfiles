...
local org_plugins = require 'plugins.org'
...
local plugins = merge(cmp_plugins, dap_plugins, git_plugins, lang_plugins,
                      org_plugins, navigator_plugins, testing_plugins,
