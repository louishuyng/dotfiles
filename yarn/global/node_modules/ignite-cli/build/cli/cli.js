...
var buildIgnite = function () {
    return gluegun_1.build()
        .brand('ignite')
        .src(__dirname + "/..")
...
module.exports = {
    run: function run(argv) {
        return __awaiter(this, void 0, void 0, function () {
            var runtime, commandLine, toolbox, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        commandLine = minimist(argv.slice(2));
                        if (commandLine.verbose && !commandLine.debug) {
                            gluegun_1.print.error('Use --debug instead of --verbose.');
                            return [2 /*return*/];
                        }
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        e_1 = _a.sent();
                        console.log(pe.render(e_1));
                        throw e_1; // rethrow
                    case 4:
                        if (toolbox.error) {
                            gluegun_1.print.debug(toolbox.error);
                        }
