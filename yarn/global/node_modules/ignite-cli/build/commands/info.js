...
var fetch_plugin_registry_1 = require("../lib/fetch-plugin-registry");
/**
...
module.exports = {
    ...
    run: function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var print, parameters, colors, newline, info, table, error, directory, name, shortName, plugin;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        print = context.print, parameters = context.parameters;
                        colors = print.colors, newline = print.newline, info = print.info, table = print.table, error = print.error;
                        return [4 /*yield*/, fetch_plugin_registry_1.default(context)];
                    case 1:
                        directory = _a.sent();
                        name = validate_name_1.default(parameters.first, context);
