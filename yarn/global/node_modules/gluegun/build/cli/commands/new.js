...
var NewCommand = {
    ...
    run: function (toolbox) { return __awaiter(_this, void 0, void 0, function () {
        var parameters, generate, filesystem, _a, error, info, colors, kebabCase, system, meta, prompt, o, props, validName, answer, answer, active, files, ext, yarnOrNpm;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _b.label = 2;
                case 2:
                    if (!(!props.typescript && !props.javascript)) return [3 /*break*/, 4];
                    info("");
