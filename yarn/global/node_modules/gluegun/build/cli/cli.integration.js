...
beforeAll(function () { return jest.setTimeout(180 * 1000); });
// reset back
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, toolbox.system.run("cd " + path.join(tmp, 'foo') + " && yarn add " + pwd + " && yarn link")
                    // Run the tests
                ];
            case 2:
                // Install local version of gluegun to test
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                expect(Object.keys(pkg.dependencies).includes('gluegun')).toBeTruthy();
                // Install local version of gluegun to test
                return [4 /*yield*/, toolbox.system.run("cd " + path.join(tmp, 'foo-ts') + " && yarn add " + pwd + " && yarn link")
                    // Run the tests
                ];
            case 2:
                // Install local version of gluegun to test
