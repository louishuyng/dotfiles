...
declare type _Drop<T extends any[], N extends Number, I extends Iteration = IterationOf<'0'>> = {
 ...
 * ```
 */
export declare type Drop<T extends any[], N extends Number, way extends Way = '->'> = {
    '->': _Drop<T, N>;
