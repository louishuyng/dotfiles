...
declare type ComposeFnSync<Fns extends Function[], K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? Fns[K] : (arg: Return<Fns[Pos<Next<IterationOf<K & string>>>]>) => Return<Fns[Pos<IterationOf<K & string>>]>;
declare type ComposeFnAsync<Fns extends Function[], K extends keyof Fns> = Length<Tail<Fns>> extends Format<K & string, 'n'> ? Fns[K] : (arg: PromiseOf<Return<Fns[Pos<Next<IterationOf<K & string>>>]>>) => Return<Fns[Pos<IterationOf<K & string>>]>;
