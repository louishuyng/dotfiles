...
# sketchybar runs scripts with a minimal PATH (no /opt/homebrew/bin) when
# launched at login, so `brew` is "command not found" and the script falls
# into the COUNT="!" branch.
