...
if test "$IS_DARK_THEME" = "false"
  ...
  sketchybar --set name icon.color=0xff000000 label.color=0xff000000 background.color=0xffE4E4E4
  ...
  for i in $LIST_SPACES_INDEX
    ...
    sketchybar --set space.$i label.highlight_color=0xffA6DA95
  end
  ...
  sketchybar --set name icon.color=0xffffffff label.color=0xffffffff background.color=0xff000000
  sketchybar --set front_app background.color=0xffCBA6F7 icon.color=0xff000000 label.color=0xff000000
