...
if test "$IS_DARK_THEME" = "false"
  ...
  sketchybar --set focus icon.color=0xff000000 label.color=0xff000000 background.color=0xff00FF00
  ...
  sketchybar --set front_app icon.color=0xffCBA6F7 label.color=0xffCBA6F7 background.color=0xff1E1E2E
