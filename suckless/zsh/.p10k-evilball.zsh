# Generated by Powerlevel10k configuration wizard on 2020-10-10 at 14:46 CST.
...
() {
  ...
  # Unset all cnfiguration options. This allows you to apply configuration changes without
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_DIR_PREFIX='%B%223Fin '
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='%B%223Ftook '
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_GOENV_VISUAL_IDENTIFIER_EXPANSION='ﳑ'
